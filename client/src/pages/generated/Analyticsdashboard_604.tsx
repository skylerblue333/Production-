...
const AnalyticsDashboard: React.FC = () => {
    ...
    return (
      <div className="p-4">
        <Alert variant="destructive">
          ...
          <AlertDescription>Failed to load real-time data: {error.message}</AlertDescription>
        </Alert>
      </div>
    );
  }
  ...
  return (
    <div className="p-4 space-y-4 dark:bg-gray-900 dark:text-white min-h-screen">
