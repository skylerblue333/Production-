...
// AUTO-GENERATED DRAFT SCREEN: DashboardAnalyticsSummary
...
const DashboardAnalyticsSummary: React.FC = () => {
  ...
  if (isError) {
    return (
      <Alert variant="destructive">
        ...
        <AlertDescription>Failed to load analytics data: {error?.message}</AlertDescription>
      </Alert>
    );
  }
  ...
  const { totalUsers, activeUsers, newRegistrations, revenue, conversionRate } = data;
